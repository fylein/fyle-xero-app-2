...
import { FyleField, MappingDestinationField, MappingSourceField, XeroField } from "src/app/core/models/enum/enum.model";
...
export const mappingRow: MappingSettingList = {
  qboField: MappingDestinationField.ACCOUNT,
