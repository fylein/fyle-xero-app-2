...
@Component({
  selector: 'app-dashboard-xero-error-dialog',
  templateUrl: './dashboard-xero-error-dialog.component.html',
  styleUrls: ['./dashboard-xero-error-dialog.component.scss']
})
export class DashboardXeroErrorDialogComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DashboardXeroErrorDialogComponent>,
