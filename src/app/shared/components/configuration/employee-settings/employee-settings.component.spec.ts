...
import { errorResponse } from '../xero-connector/xero-connector.fixture';
...
describe('EmployeeSettingsComponent', () => {
  ...
  beforeEach(async () => {
    service = {
      getDistinctXeroDestinationAttributes: () => of(response2)
    };
  ...
  it('should create', () => {
    ...
    spyOn(mappingService, 'getDistinctXeroDestinationAttributes').and.callThrough();
    ...
    fixture.detectChanges();
    expect(mappingService.getDistinctXeroDestinationAttributes).toHaveBeenCalled();
