...
export class EmployeeSettingsComponent implements OnInit, OnDestroy {
  ...
  autoMapEmployeeOptions: EmployeeSettingFormOption[] = [
    ...
    },
    {
      ...
      label: 'Fyle Name to Xero Display name'
    },
    {
      value: AutoMapEmployee.EMAIL,
      label: 'Fyle Email to Xero Email'
    },
    {
      value: AutoMapEmployee.EMPLOYEE_CODE,
      label: 'Fyle Employee Code to Xero Display name'
    }
  ];
  ...
  private setupForm(): void {
    ...
    forkJoin([
      ...
      this.mappingService.getDistinctXeroDestinationAttributes([EmployeeFieldMapping.EMPLOYEE, EmployeeFieldMapping.VENDOR]),
