...
describe('MappingService', () => {
  ...
  it('getXeroDestinationAttributes() service check', () => {
    ...
    const req = httpMock.expectOne({
      method: 'GET',
      url: `${API_BASE_URL}/workspaces/${workspace_id}/xero/destination_attributes/?attribute_type__in=ACCOUNT&active=true`
    });
      req.flush([]);
  ...
  it('getGroupedXeroDestinationAttributes() withdata service check', () => {
    ...
    const req = httpMock.expectOne({
      method: 'GET',
      url: `${API_BASE_URL}/workspaces/${workspace_id}/xero/destination_attributes/?attribute_type__in=BANK_ACCOUNT,CONTACT,ACCOUNT,TENANT`
    });
